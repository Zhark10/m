        ...
        >
          <View style={Step2Styles.CARD_CONTENT}>
            <View style={Step2Styles.CARD_CONTENT_LEFT_BOX}>
              ...
              <TouchableOpacity style={Step2Styles.CARD_CONTENT_LEFT_BOX_LOCATION_ICON_BUTTON} onPress={() => null}>
                <FontAwesome5Icon name='location-arrow' style={Step2Styles.CARD_CONTENT_LEFT_BOX_ICON} />
                <FontAwesome5Icon name='angle-double-right' style={[Step2Styles.CARD_CONTENT_LEFT_BOX_ICON, { color: color.palette.opacity.black72, paddingLeft: 12, }]} />
              </TouchableOpacity>
              <TouchableOpacity style={Step2Styles.CARD_CONTENT_LEFT_BOX_ICON_BUTTON} onPress={() => null}>
                <FontAwesomeIcon name='repeat' style={[Step2Styles.CARD_CONTENT_LEFT_BOX_ICON, { color: color.palette.opacity.black72 }]} />
