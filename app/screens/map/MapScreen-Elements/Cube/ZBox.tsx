...
const ZBox = ({ width, height, depth, front, back, top, bottom, left, right }: ZBoxProps) => {
  ...
  return (
    <>
      <Vertex
        points={points.v1}
        // pointsForCount={countPoints.v1}
        fill={front}
      />
      <Vertex
        points={points.v2}
        // pointsForCount={countPoints.v2}
        fill={back}
      />
      <Vertex
        points={points.v3}
        // pointsForCount={countPoints.v3}
        fill={left}
      />
      <Vertex
        points={points.v4}
        // pointsForCount={countPoints.v4}
        fill={right}
      />
      <Vertex
        points={points.v5}
        // pointsForCount={countPoints.v5}
        fill={top}
      />
      <Vertex
        points={points.v6}
        // pointsForCount={countPoints.v6}
        fill={bottom}
      />
    </>
  )
